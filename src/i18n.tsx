...
export const strings = {
  en: {
    ...
    promoBadge: 'Promo',
    wasPrice: 'Was',
    choiceLabel: 'Please choose',
    messagesTitle: 'Kind words',
    messagesIntro: 'Notes and gifts appear here as they arrive.',
    messagesEmpty: 'No messages yet.',
    thanksLabel: 'Thank-you from the family',
    thanksFrom: 'Sherally and Steven',
    donatedFor: 'contributed toward',
    offered: 'chose',
    donateTitle: 'A contribution',
    donateBody:
      'PayPal or Wero — as you prefer. Both reach Sherally and Steven directly.',
    donateBtn: 'Contribute with PayPal',
    donateWero: 'Contribute with Wero',
    paypalHint: 'A transfer in a few moments.',
    weroHint: 'From your bank app, to this number.',
  ...
  fr: {
    ...
    thanksLabel: 'Remerciement de la famille',
    thanksFrom: 'Sherally and Steven',
    donatedFor: 'a contribué pour',
    offered: 'a choisi',
    donateTitle: 'Une contribution',
    donateBody:
      'PayPal ou Wero — comme vous préférez. Les deux parviennent directement à Sherally et Steven.',
    donateBtn: 'Contribuer par PayPal',
    donateWero: 'Contribuer par Wero',
    paypalHint: 'Un virement, en quelques instants.',
    weroHint: 'Depuis l’application de votre banque, vers ce numéro.',
